...
const HeroSection = () => {
 ...
 <a href="\upload" className="bg-green text-white text-center uppercase font-semibold px-4 py-2 rounded-md inline-block hover:scale-105 mt-10">
  Get Started
 </a>
  </h1>
...
<section className=" bg-darkGray py-16 bg-gray-100">
    ...
    <section aria-label="Site Footer" className=" bg-gray-900 text-white">
        <div className="max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
          ...
          <p className="text-xs text-gray-500">
            NextJS template created with ❤️ by <Link href="https://soumyamondal.com" className="text-gray-500 transition hover:opacity-75">Parjon</Link>
          </p>
        </div>
      </section>
    </footer>
